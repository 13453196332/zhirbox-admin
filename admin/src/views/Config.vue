<template>
  <div>
    <h2 style="color:#f1f5f9;margin-bottom:20px">站点配置</h2>
    <el-card shadow="never" style="background:rgba(255,255,255,0.04);border:1px solid rgba(0,212,255,0.12);max-width:700px">
      <el-form :model="config" label-width="120px" label-position="left">
        ...
        <el-divider content-position="left" style="border-color:rgba(0,212,255,0.15)">联系方式</el-divider>
